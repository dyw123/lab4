...
* Fills the array with random numbers between 50 and 80 The instance

* variable named intArray is the integer array to be filled with values
...
* Prints array to the console, elements are separated by a space The

* instance variable named intArray is the integer array to be printed
...
* Finds the number of times value is found in the array The instance

* variable named intArray is the integer array
...
"Enter a row number between 0 and 3");
...
JOptionPane.showMessageDialog(null, "Values in row "

+ rowSelected + " set to " + key + message);
...
"Enter a column number between 0 and 19");
...
String displayMessageMin = "In column " + columnSelected

+ ", you found a minimum value of ";
...
String displayMessageFrequency = "You found " + key + " "

+ frequency + " time" + plural;
...
.showMessageDialog(null, displayMessageFrequency);

else

JOptionPane.showMessageDialog(null,

"You did not find the value " + key);
...
"Wrong number of arguments to animate method");
